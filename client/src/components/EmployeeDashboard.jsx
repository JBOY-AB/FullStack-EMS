        ...
        <div className='animate-fade-in'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8'>
                {cards.map((card, index) => (
                    ...
                    >
                        {/* Left border accent */}
                        <div className='absolute left-0 top-0 bottom-0 w-1 rounded-r-full bg-slate-500/70 group-hover:bg-navy-500/70 transition-colors duration-200' />
                        ...
                        {/* Icon */}
                        <card.icon className='size-10 p-2.5 rounded-lg bg-slate-100 text-slate-600 group-hover:bg-navy-50 group-hover:text-navy-600 transition-colors duration-200' />
                    </div>
                ))}
            </div>
