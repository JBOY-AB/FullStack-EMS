    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className='flex-1 flex items-center justify-center p-6 sm:p-12 bg-white'>
        <div className="w-full max-w-md animate-fade-in">
          <Link to="/login" className='inline-flex items-center gap-2 text-slate-400 hover:text-slate-700 text-sm md-10 transition-colors'>
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-500 text-slate-500 text-sm sm:text-base mt-2">{subtitle}</p>
          </div>
