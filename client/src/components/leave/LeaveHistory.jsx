import { Check, Loader, Loader2, Loader2Icon, X } from 'lucide-react'
                        ...
                        return (
                          <tr key={leave._id || leave.id}>
                            {isAdmin && (
                                ...
                                bg-slate-100 text-slate-600'>{leave.type}</span>
                                </td>
                                ...
                                <td className='max-w-xs truncate text-slate-500' title={leave.reason}>
                                  ...
                                  <td>
                                    <span className={`badge ${leave.status === "APPROVED" ? "badge-success" : leave.status === "REJECTED" 
