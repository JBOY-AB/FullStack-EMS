...
const Layout = () => {
  ...
  if(user.mustChangePassword) {
    return (
      <div className="h-screen bg-linear-to-br from-slate-50 via-white to-navy-50/30">
  ...
  return (
    <div className="flex h-screen bg-linear-to-br from-slate-50 via-white to-navy-50/30">
        <Sidebar />
